...
#
# Later I may add features like stripping non-ascii characters in the plaintext (other than spaces), generating random OTP values, specifying pre-shared parts of the OTP to start from, etc.
#
